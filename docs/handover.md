...
| 1.57 | [`design/daemon-runtime.md`](design/daemon-runtime.md) | **草案**——daemon 跑起來之後：每個帳號一組上游會話（探到 wbf 走四條 WS、否則落 HTTP）、事件怎麼變成推播、進度歸屬（`job`）、`cancel` 停掉什麼與留下什麼。2026-09-13 第一版，§6 有分階段 |
